...
azi=[0 180]+90;	% azimuth angles in degrees. If negative values are found, navigational system (-180;+180) will be used. 
ele=[0]; %elevation angles in degrees
...
if ~exist('dontplay','var'); sound(out,fs); end